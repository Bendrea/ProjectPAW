...
?>
                ...
                <strong class="text-sm-left">Adaugat de: <?php echo $autor['username'] ?> <br>
                    ...
                    Raiting:<?php echo $raiting ?>  <a href="adaugareRaiting.php?GetID=<?php echo $row['id']?>">Add Raiting</a>
                    <a href="stergereContent.php?DelID=<?php echo $row['id']?>">Delete Content</a>
                </strong>
